...
<ul>
   ...
   <li class='active has-sub'><a href='#'><span>Courses</span></a>
      <ul>
         <li class='has-sub'><a href='#'><span>C</span></a>
   ...
   <li><a href='#'><span>Test</span></a>
   	 ...
   	 ResultSet rs=connection.getResults(s);
   	 	...
   	 	%>
         <li class='has-sub'><a href='fetchQuestions.jsp?courseId=<%=rs.getString(2)%>'><span><%=rs.getString(1) %></span></a>
   ...
   <li class='last'><a href="header/Contact.jsp"><span>Contact</span></a></li>
