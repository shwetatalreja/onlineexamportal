...
<div class="zf-templateWidth"><form action='UserRegisterPost1.jsp' name='form' method='POST' onSubmit='javascript:document.charset="UTF-8"; return zf_ValidateAndSubmit();' accept-charset='UTF-8' enctype='multipart/form-data' id='form'><input type="hidden" name="zf_referrer_name" value=""><!-- To Track referrals , place the referrer name within the " " in the above hidden input field -->
...
<li class="zf-radio zf-tempFrmWrapper zf-threeColumns"><label class="zf-labelName">Set type:-
</label>
<div class="zf-tempContDiv"><div class="zf-overflow">
<span class="zf-multiAttType"> 
<input class="zf-radioBtnType" type="radio" id="Radio_1" name="sg" checktype="c1" value="ADMIN">
<label for="Radio_1" class="zf-radioChoice">ADMIN</label> </span>
<span class="zf-multiAttType"> 
<input class="zf-radioBtnType" type="radio" id="Radio_2" name="sg" checktype="c1" value="User">
<label for="Radio_2" class="zf-radioChoice">USER</label> </span>
<div class="zf-clearBoth"></div></div><p id="Radio_error" class="zf-errorMessage" style="display:none;">Invalid value</p>
</div><div class="zf-clearBoth"></div></li>
